...
/**
 * 読書記録に関する業務処理を担当するServiceクラス。
 * 読書記録の登録・取得・更新・削除、および語数集計や進捗率の計算を行う。
 */
@Service
public class BookRecordService {
	...
	/**
	 * 指定された読書記録を取得し、ログインユーザーの所有する記録であることを確認する。
	 * @param userId ユーザーID
	 * @param recordId 本の記録ID
	 * @return 指定された読書記録
	 * @throws IllegalArgumentException 指定した記録がない場合
	 * @throws AccessDeniedException 読書記録の所有者とログインユーザーが一致しない場合
	 */
